...
function createProductCard(p) {
  const continaire = document.getElementById('productGrid');
    ...
    const fullImagePath = `../../public/${p.image_path}`;
   const pathNextimages = getNextImages(p.image_path);
   const fullImagePath1 = `../../public/${p.image_path}`;
   const fullImagePath2 = `../../public/${pathNextimages[0]}`;
   const fullImagePath3 = `../../public/${pathNextimages[1]}`;
